		...
		<Card
			...
			body = {show ? (
				...
				<div className="text-left">	
						<img src="pay7.gif" className="img-fluid left" alt="Responsive image" width="30%"/><br/><br/>
					</div>
				Please log in to withdraw funds from your account and check your balance. <a href='#/login/' className="btnDeposit" data-toggle="tooltip" title="Sign in with your existing account credentials">Login</a><br/><br/>
				You don't have an account? Create an account if you would like to enjoy our services. <a href="#/createaccount/" className="btnDeposit" data-toggle="tooltip" title="Create a new account">Create Account</a>
				</>
			):(
				<>
				...
				{disabled ? (
					...
					<div className="text-left">	
						<img src="tra7.gif" className="img-fluid left" alt="Responsive image" width="30%"/><br/><br/>
					</div>
					</>
				)}
				</>
