		...
		<Card
			...
			body = {show ? (
				...
				<div className="text-left">	
						<img src="tra1.gif" className="img-fluid left" alt="Responsive image" width="30%"/><br/><br/>
					</div>

				Please log in to deposit funds and check your balance. <a href='#/login/' className="btnDeposit" data-toggle="tooltip" title="Login to your account">Login</a><br/><br/><br/>
